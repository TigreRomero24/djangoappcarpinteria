...
class Empresa(models.Model):
    ...
    direccion = models.TextField(max_length=300, blank=True, null=True)
    mision = models.TextField(max_length=300, blank=True, null=True)
    vision = models.TextField(max_length=300, blank=True, null=True)
